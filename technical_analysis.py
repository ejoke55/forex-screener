...
class TechnicalAnalyzer:
    ...
    def calculate_pivot_points(self, df):
        ...
        Fibonacci Pivots use Fibonacci ratios (0.382, 0.618, 1.0, 1.618)
        for more precise support/resistance levels

        Args:
            df: DataFrame with OHLC data

        Returns:
            dict: Fibonacci pivot points (PP, R1-R4, S1-S4)
        """
        ...
        # Calculate pivot point (same formula)
        pp = (high + low + close) / 3
        ...
        r2 = pp + (0.618 * range_hl)  # 61.8% Fibonacci (Golden Ratio)
        r3 = pp + (1.000 * range_hl)  # 100% extension
        r4 = pp + (1.618 * range_hl)  # 161.8% Fibonacci extension

        # Fibonacci support levels
        s1 = pp - (0.382 * range_hl)  # 38.2% Fibonacci
        s2 = pp - (0.618 * range_hl)  # 61.8% Fibonacci (Golden Ratio)
        s3 = pp - (1.000 * range_hl)  # 100% extension
        s4 = pp - (1.618 * range_hl)  # 161.8% Fibonacci extension
