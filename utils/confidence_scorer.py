...
class ConfidenceScorer:
    ...
    def calculate_timeframe_alignment_score(self, signal_data):
        """
        Calculate score based on timeframe alignment (30 points max)
    ...
    def calculate_ma_convergence_score(self, ma_cross_data, ma_pullback_data):
        """
        Calculate score based on MA strategy convergence (25 points max)
    ...
    def calculate_trend_strength_score(self, signal_data):
        """
        Calculate score based on ADX trend strength (20 points max)
        ...
        """
        timeframes = ['M5', 'M15', 'H1', 'H4', 'D']
        adx_strengths = [signal_data.get(f'{tf}_adx', 'N/A') for tf in timeframes]

        # Count strong ADX readings
    ...
    def calculate_historical_win_rate_score(self, strategy_name):
        """
        Calculate score based on strategy historical win rate (10 points max)
    ...
    def calculate_confidence(self, signal_data, ma_cross_data=None, ma_pullback_data=None,
        ...
        if ma_cross_data and ma_pullback_data:
            ...
            ma_convergence_score = min(abs(signal_data.get('score', 0)) * 4, 25)
